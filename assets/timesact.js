    ...
    timesactScriptNew = async function ($) {
                ...
                window.ta = {
                    ...
                    quickView: {
                        selectors: {
                            ...
                            form: `[data-block-type="buy-buttons"] form[action='/cart/add']:visible`,
                            addToCartButton: "[type=submit]:visible:first",
                            variant: "variant-picker button, #sca-qv-variant-options select.single-option-selector, .bc-quickview-single-option-selector, .searchit-option-selector-wrapper select, .qview-variants select, select:visible, .radio-wrapper fieldset, input[type='radio']",
        ...
        class Timesact {
            ...
            createWidget() {
                ...
                // this.selectors.buttonSelector = $(window.ta.quickView.selectors.quickviewModalContainer).find(window.ta.quickView.selectors.button);
        ...
        class TimesactEventListener {
            initVariantEventListener(preorder) {
                ...
                }), $('.popover__value-option').click(function(e) {
                  event.variantChangeHandler(preorder);
                }),
